...
export const MiCuenta = ({ registro, usuario, favorito, toggleFavorito, addToCart , misCompras, usado, nombreCuponActivo, setNombreCuponActivo, cuponesValidos, misOpiniones, guardarOpinion }) => {
